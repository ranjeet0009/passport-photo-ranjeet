...
TOP_SPACE_RATIO = 0.10 # Further reduced top space ratio
SHOULDER_EXTENSION = 0.35
ZOOM_OUT_FACTOR = 1.40 # Increased zoom out factor
...
def standardize_passport_photo(image):
    ...
    # Edge smoothing
    img_white_final = img_white_final.filter(ImageFilter.GaussianBlur(radius=0.8))
