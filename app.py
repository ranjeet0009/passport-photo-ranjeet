...
SHOULDER_EXTENSION = 0.70 # Increased shoulder extension for more vertical coverage
ZOOM_OUT_FACTOR = 1.40 # Increased zoom out factor for more overall breathing room
