...
def standardize_passport_photo(image):
    ...
    # Calculate dimensions for the initial crop with adjusted zoom-out and shoulder extension
    total_height = int((h / FACE_HEIGHT_RATIO) * ZOOM_OUT_FACTOR)
    top_space = int(total_height * TOP_SPACE_RATIO)
    shoulder_space = int(h * SHOULDER_EXTENSION) # Use adjusted shoulder extension
